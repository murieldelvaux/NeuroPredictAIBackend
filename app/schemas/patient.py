...
class PatientResponse(Patient):
    """Schema de resposta com datas formatadas (dd/mm/aaaa) e sexo por extenso."""

    @model_serializer(mode="wrap")
    def serialize_with_formatted_fields(self, handler) -> dict:
        data = handler(self)
        ...
        if data.get("created_at"):
            try:
                ...
                pass
        # Formata date_of_birth para dd/mm/aaaa
